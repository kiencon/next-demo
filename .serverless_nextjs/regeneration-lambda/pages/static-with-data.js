...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ static_with_data; },
...
const User = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("p", {
      ...
      children: ["title: ", user.title]
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("p", {
      children: ["completed: ", user.completed]
    })]
  });
};

/* harmony default export */ var components_user = (User);
;// CONCATENATED MODULE: ./pages/static-with-data.js
...
const StaticWithoutData = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/jsx_runtime.jsx(head.default, {
      ...
      className: "users",
      children: users.map(user => user.id % 2 === 0 ? /*#__PURE__*/jsx_runtime.jsx(next_link.default, {
        href: `/user/${user.id}`,
        children: /*#__PURE__*/jsx_runtime.jsx("a", {
          children: /*#__PURE__*/jsx_runtime.jsx(components_user, {
            user: user
          })
        })
      }, user.id) : /*#__PURE__*/jsx_runtime.jsx(next_link.default, {
        href: `/user-server/${user.id}`,
        children: /*#__PURE__*/jsx_runtime.jsx("a", {
          children: /*#__PURE__*/jsx_runtime.jsx(components_user, {
            user: user
          })
...
/* harmony default export */ var static_with_data = (StaticWithoutData);
const getStaticProps = async () => {
  const {
    data: users
  } = await axios_default().get('https://jsonplaceholder.typicode.com/todos');
  return {
    props: {
      users: users
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9436);
      ...
      processEnv([{"path":".env","contents":"stage='prod'\ndistributionId='E2HY8W4ONEAWOH'\n"}])
      ...
      const compMod = __webpack_require__(1283)
      ...
      const { renderReqToHTML, render } = (0,next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__/* .getPageHandler */ .u)({
        ...
        i18n: undefined,
        page: "/static-with-data",
        buildId: "IddJIQsIRNbcQdcqOB3JU",
        escapedBuildId: "IddJIQsIRNbcQdcqOB3JU",
        basePath: "",
        pageIsDynamic: false,
        encodedPreviewProps: {previewModeId:"7c07a279654a5a8c50df53876977d360",previewModeSigningKey:"dd19f6061a9cdb504e6406efa4605b9cb4affb0f36fc8bf0eddbce84565fe784",previewModeEncryptionKey:"c7a0b12db7883ead4e07c487abfc50330fccc9c346926373ec5e0127df1ff24b"}
      })
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [249,751,664,669,8,428,730], function() { return __webpack_require__(7344); })
...
/******/ 		__webpack_require__.x = function() {
/******/ 			__webpack_require__.e(249);
/******/ 			__webpack_require__.e(751);
