...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ _id_User; },
...
function _id_User({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/jsx_runtime.jsx(next_link.default, {
      ...
      children: "Home"
    }), /*#__PURE__*/jsx_runtime.jsx(components_user, {
      user: user
    })]
  });
}
...
const getStaticProps = async ({
  ...
  const {
    data: user
  } = await axios_default().get(`https://jsonplaceholder.typicode.com/todos/${params.id}`);
  return {
    props: {
      user: user
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9436);
      ...
      const compMod = __webpack_require__(218)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [249,751,775,664,669,428,730], function() { return __webpack_require__(3962); })
